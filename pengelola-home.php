...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg); position: relative; overflow: hidden; margin-top: 70px ; z-index: 2;">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Welcome to Our Haven, <br> Manager!</h1>
       ...
       <!-- Room Start -->
                            ...
                            <div class="room-item shadow rounded overflow-hidden">
                                <div class="p-4 mt-2">
                                    ...
                                    <div class="container" style="width: 450px">
                                        <p class="text-center">Tambahkan Pengeluaran</p>
                                        <form method="POST" action="pengeluaran-process.php">
                                            

                                            <!-- jenis pengeluaran -->
                                            <select class="mt-3 form-select" name="kategori">
                                                <option selected hidden value="">Kategori Pengeluaran</option>
                                                <option value="Pembayaran">Pembayaran</option>
                                                <option value="Perbaikan">Perbaikan</option>
                                                <option value="Kebersihan">Kebersihan</option>
                                            </select>
                                            <input class="form-control mt-3" type="text" name="deskripsi" placeholder="Deskripsi" required="">
                                            <input class="form-control mt-3" type="text" name="jumlah" placeholder="Jumlah" required="">
                                        ...
                                        <?php
                                            ...
                                            while ($data = mysqli_fetch_array($query)) { ?>
                                              <tr>
                                                ...
                                                <td><?= $data["proses"] ?></td>
                                                <td>
                                                    <a href="pengelola-keluhan-edit.php#keluhan" class="btn btn-sm btn-primary rounded py-2 px-4">Edit</a>
                                                </td>
                                              </tr>
                                                <?php $nomor++; 
                                        } ?>
        ...
        <!-- Back to Top -->
        <a href="pengelola-home.php" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    </div>
